...
import AvatarSayPortfolio from '../../atoms/AvatarSayPortfolio';
...
import IconsJumpsPortfolio from './IconsJumpsPortfolio';

export default function AdvertMePortfolio({ data }) {
  return (
    <div className={style.advertme_container}>
      <AvatarSayPortfolio name={data.name} src='https://picsum.photos/536/354' />
